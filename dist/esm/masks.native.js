import { combineMasks, createIdentityMask, createInverseMask, createMask, createSoftenMask, createStrengthenMask, skipMask } from "@hanzogui/create-theme";
var masks = {
  ...
  strengthenButSoftenBorder: createMask(function (template, options) {
    ...
    var softer = createSoftenMask().mask(template, options);
    return {
      ...stronger,
